    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingAmenities", x => new { x.AmenitiesId, x.ListingId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalNights = table.Column<int>(type: "int", nullable: false, computedColumnSql: "DATEDIFF(day, StartDate, EndDate)"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookingss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bookingss_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookingss_Users_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Amenities_Name_Category",
                table: "Amenities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookingss_GuestId",
                table: "Bookingss",
                column: "GuestId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookingss_RoomId",
                table: "Bookingss",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookingss_StartDate_EndDate",
                table: "Bookingss",
